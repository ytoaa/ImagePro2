...
// ImagePro2.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
CImagePro2App::CImagePro2App() noexcept
{
	...
	SetAppID(_T("ImagePro2.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CImagePro2App 개체입니다.

CImagePro2App theApp;
...
BOOL CImagePro2App::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_ImagePro2TYPE,
		RUNTIME_CLASS(CImagePro2Doc),
		RUNTIME_CLASS(CChildFrame), // 사용자 지정 MDI 자식 프레임입니다.
		RUNTIME_CLASS(CImagePro2View));
	if (!pDocTemplate)
		return FALSE;
...
int CImagePro2App::ExitInstance()
{
